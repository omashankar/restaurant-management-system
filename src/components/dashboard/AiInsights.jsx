      ...
      <div className="mt-4 grid gap-2 sm:grid-cols-2 xl:grid-cols-1 2xl:grid-cols-2">
        {aiInsights.map((insight, i) => {
          ...
          return (
            <div
              key={i}
              className={`flex items-start gap-3 rounded-xl border p-3 ${s.card}`}
            >
              <span
                className={`mt-0.5 flex size-7 shrink-0 items-center justify-center rounded-lg ring-1 ${s.icon}`}
              >
