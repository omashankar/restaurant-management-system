          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-0.5 truncate text-[11px] admin-surface-faint" title={r.id}>
                  {r.id}
                </p>
              </div>
            ...
            <AdminTableBody>
              {rows.map((r) => (
                <AdminTableRow key={r.id} className="hover:bg-[var(--admin-hover)]/35">
                  <AdminTableTd className="max-w-[10rem] min-w-0 sm:max-w-none">
                    <p className="truncate font-medium admin-shell-text">{r.customerName}</p>
                    <p className="truncate text-[11px] admin-surface-faint" title={r.id}>
                      {r.id}
                    </p>
                  </AdminTableTd>
