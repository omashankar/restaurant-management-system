...
export default function MenuItemCard({ item, onAdd, disabled, className = "" }) {
  return (
    <div
      className={`group flex flex-col rounded-2xl border border-zinc-800 bg-zinc-900/70 p-4 transition-all duration-200 hover-border-ra-primary-40 hover:shadow-lg hover:shadow-ra-primary-soft ${className}`}
    >
