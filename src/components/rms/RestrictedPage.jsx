...
export default function RestrictedPage({ title = "Access restricted", message }) {
  ...
  return (
    <div className="flex min-h-[50vh] flex-col items-center justify-center rounded-2xl border border-amber-500/25 bg-amber-500/5 p-10 text-center">
      ...
      <Link
        href={home}
        className="cursor-pointer mt-8 rounded-xl border border-zinc-700 px-5 py-2.5 text-sm font-medium text-zinc-200 transition-colors hover:border-ra-primary-50 hover-bg-ra-primary-10"
      >
        Back to workspace
      </Link>
    </div>
