 ...
 * Renders hero section from CMS data passed as props.
 * Falls back to static strings if a field is missing.
 */
  ...
  return (
    <section className="relative mx-auto grid w-full max-w-7xl gap-10 px-4 pb-16 pt-14 sm:px-6 lg:grid-cols-2 lg:gap-14 lg:px-8 lg:pt-20">
      ...
      <div className="flex flex-col justify-center space-y-6">
        ...
        <p className="max-w-lg text-base leading-relaxed text-slate-600">{subheadline}</p>
      ...
      {/* Dashboard mockup — static, always the same */}
