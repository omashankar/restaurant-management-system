      ...
      <div className="mt-5">
        <Field label="Default Payment Method">
          <select
            ...
            className="w-full cursor-pointer rounded-xl border border-zinc-800 bg-zinc-950/80 px-3 py-2.5 text-sm text-zinc-100 outline-none transition-colors focus-ra-primary"
          >
