...
export const POS_MENU_ITEMS = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1622597467836-f3285d2137b7?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "mi-5",
    name: "Mango Smoothie",
    ...
    prepTime: 4,
    kitchenType: "default_kitchen",
    image: "https://images.unsplash.com/photo-1613478223719-2eb800eea4db?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "mi-6",
    name: "Iced Latte",
    ...
    prepTime: 5,
    kitchenType: "default_kitchen",
    image: "https://images.unsplash.com/photo-1461023058943-07fc16d8d5b4?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "mi-7",
...
export const POS_TABLES = [
  { id: "tb-1", name: "Table 1", status: "available" },
  { id: "tb-2", name: "Table 2", status: "occupied" },
  { id: "tb-3", name: "Table 3", status: "available" },
  { id: "tb-4", name: "Table 4", status: "reserved" },
  { id: "tb-5", name: "Table 5", status: "available" },
  { id: "tb-6", name: "Table 6", status: "occupied" },
  { id: "tb-7", name: "Table 7", status: "available" },
  { id: "tb-8", name: "Table 8", status: "available" },
];
