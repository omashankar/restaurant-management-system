    ...
    <div className="admin-surface-card p-6">
      <div className="mb-5 flex items-center gap-3">
        ...
        <div>
          ...
          {description ? <p className="text-xs admin-surface-muted">{description}</p> : null}
        </div>
      </div>
      {children}
    </div>
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        ...
        <p className="admin-page-desc mt-1 text-sm">Manage your super admin profile and security.</p>
      </div>
