...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {showToast ? (
        <div className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-xl border border-emerald-500/30 bg-zinc-900 px-4 py-2 text-sm text-emerald-300 shadow-2xl shadow-black/40">
