          ...
          {activeTab === "overview" && (
            <div className="space-y-6">
              <p className="text-sm admin-surface-muted">
                Use the <strong className="admin-shell-text">left tabs</strong> for your public website text and images.
              ...
              <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 px-4 py-3 text-xs text-zinc-400">
                ...
                <ul className="mt-2 list-inside list-disc space-y-1 text-zinc-500">
                  ...
                  <li>
                    <strong className="admin-surface-body">Address, phone, hours</strong> — Settings (Contact & Hours).
                  </li>
                  <li>
                    <strong className="admin-surface-body">Menu dishes & prices</strong> — Menu admin, not Customer Site.
                  </li>
                  <li>
                    <strong className="admin-surface-body">Social URLs</strong> — Website layout (one place for header & footer).
                  </li>
                </ul>
              </div>
              ...
              <div className="grid gap-3 lg:grid-cols-2">
                ...
                <div className="rounded-xl admin-surface-card px-4 py-3">
                  <p className="admin-surface-label text-xs font-semibold mb-2">Also managed elsewhere</p>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {[
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 rounded-xl admin-surface-card px-4 py-3 transition-colors hover:border-ra-primary-30"
                  >
          ...
          {activeTab === "announcement" && (
            <div className={CMS_EDITOR_SECTION}>
              ...
              {announcement.text?.trim() && (
                <div>
                  <p className="mb-2 text-xs font-medium admin-surface-muted">Preview</p>
                  <div
