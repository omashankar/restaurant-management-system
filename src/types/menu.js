...
export const ITEM_TYPE_META = {
  veg:       { label: "Veg",     emoji: "🟢", dot: "bg-emerald-500", badge: "bg-emerald-500/15 text-emerald-300 ring-emerald-500/25", border: "border-emerald-500/30" },
  "non-veg": { label: "Non-Veg", emoji: "🔴", dot: "bg-red-500",     badge: "bg-red-500/15 text-red-300 ring-red-500/25",           border: "border-red-500/30" },
  ...
  other:     { label: "Other",   emoji: "",   dot: "bg-zinc-500",     badge: "bg-zinc-500/15 text-zinc-400 ring-zinc-500/25",         border: "border-zinc-700" },
};
