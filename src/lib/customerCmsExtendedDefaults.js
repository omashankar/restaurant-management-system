...
export const DEFAULT_CONTACT_PAGE = {
  ...
  title: "Contact Us",
  subtitle: "Call, email, or visit us — we're here for orders, table bookings, and any questions.",
  detailsTitle: "Contact details",
  detailsSubtitle: "Address, phone, and email for orders and support.",
  hoursTitle: "Opening Hours",
  hoursSubtitle: "Plan your visit or pickup time",
  socialLabel: "Follow us on social media",
  ctaTitle: "Ready to order?",
  ctaSubtitle: "Browse the menu and get your favourites delivered or ready for pickup.",
  ctaButtonLabel: "View menu",
};
...
export const DEFAULT_MENU_LABELS = {
  ...
  typeLabel: "Food type",
  sortLabel: "Sort by",
  quickLabel: "Quick filter",
  filterHelpText: "Pick a category, then food type if needed. Only options with dishes are shown.",
  activeFiltersLabel: "Applied",
  searchTagPrefix: "Search",
  showingOfLabel: "Showing {count} of {total} dishes",
  allDishesLabel: "{total} dishes available",
  sortDefaultLabel: "Default order",
  sortNameLabel: "Name A–Z",
  sortPriceAscLabel: "Price: Low to High",
  sortPriceDescLabel: "Price: High to Low",
  sortFastLabel: "Fastest first",
