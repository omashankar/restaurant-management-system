export const ACCESS_CONTROL_FEATURES = [
  ...
  { key: "billing", label: "Billing", routes: ["/billing"] },
  { key: "supportTickets", label: "Support Tickets", routes: ["/support-tickets"] },
...
export const DEFAULT_ACCESS_CONTROL = {
  ...
  billing: { admin: true, manager: false, waiter: false, chef: false },
  supportTickets: { admin: true, manager: true, waiter: true, chef: true },
