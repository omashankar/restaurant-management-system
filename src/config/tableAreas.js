...
export const TABLE_AREAS = [
  {
    ...
    label: "Indoor",
    Icon: Leaf,
    activeClasses:  "border-ra-primary-60 bg-ra-primary-10 ring-1 ring-ra-primary-25 text-ra-primary",
    hoverClasses:   "hover-border-ra-primary-30 hover:bg-ra-primary-5",
    iconColor:      "text-ra-primary",
    iconBg:         "bg-ra-primary-10",
  },
  {
    id: "outdoor",
    label: "Outdoor",
